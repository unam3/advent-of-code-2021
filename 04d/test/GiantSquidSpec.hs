...
--                Nothing
    ...
    describe "drawNumberUntilLastPossibleWin'" $ do
        --it "returns empty map if the only one board available wins"
        --    $ shouldBe
        ...
        it "go through all the boards (winning order: 2, 1, 0)"
            $ shouldBe
                (drawNumberUntilLastPossibleWin'
                    (
                        [7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1],
        ...
        --it "go through all the boards (winning order: 0, 1, 2)"
        --    $ shouldBe
        --        (drawNumberUntilLastPossibleWin'
        --            (
        --                [7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1],
        ...
        --it "go through all the boards (winning order: 0, 2)"
        --    $ shouldBe
        --        (drawNumberUntilLastPossibleWin'
        --            (
        --                [7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1],
